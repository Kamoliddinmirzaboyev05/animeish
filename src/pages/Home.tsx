...
import { HeroSkeleton, AnimeSliderSkeleton } from '../components/Skeletons';
        ...
        <div className="max-w-7xl mx-auto px-0 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-6 sm:space-y-8">
          {loading ? (
            <div className="space-y-6 sm:space-y-8">
              <AnimeSliderSkeleton title="Tomosha Davom Etish" />
              <AnimeSliderSkeleton title="Hozir Mashhur" />
              <AnimeSliderSkeleton title="Bu Hafta Ommabop" />
              <AnimeSliderSkeleton title="Yangi Chiqarilganlar" />
            </div>
          ) : (
            <>
