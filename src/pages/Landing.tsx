...
const Landing = () => {
  return (
    <div className="min-h-screen">
      ...
      <footer className="py-16 bg-dark-light border-t border-dark-lighter">
        <div className="max-w-7xl mx-auto px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-dark hover:bg-primary rounded-full flex items-center justify-center transition-colors">
